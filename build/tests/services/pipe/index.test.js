...
const pipe_1 = require("../../../services/pipe");
describe('Pipe', () => {
    let pipe;
    let rules;
    let jobData;
    ...
    describe('array', () => {
        it('should join an array with a space delimiter', () => {
            ...
            pipe = new pipe_1.Pipe(rules, jobData);
    ...
    describe('math', () => {
        it('abs, acos, acosh, tanh, trunc, atan2, hypot', () => {
            ...
            const pipeAbs = new pipe_1.Pipe(rulesAbs, jobData);
            ...
            const pipeAcos = new pipe_1.Pipe(rulesAcos, jobData);
            ...
            const pipeAcosh = new pipe_1.Pipe(rulesAcosh, jobData);
            ...
            const pipeTanh = new pipe_1.Pipe(rulesTanh, jobData);
            ...
            const pipeTrunc = new pipe_1.Pipe(rulesTrunc, jobData);
        ...
        it('atan2', () => {
            ...
            const pipeAtan2 = new pipe_1.Pipe(rulesAtan2, jobData);
        ...
        it('hypot', () => {
            ...
            const pipeHypot = new pipe_1.Pipe(rulesHypot, jobData);
        ...
        it('max', () => {
            ...
            const pipeMax = new pipe_1.Pipe(rulesMax, jobData);
