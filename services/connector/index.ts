...
import {
  PubSubDBEngine,
  PubSubDBWorker } from '../../types/pubsubdb';
...
export class ConnectorService {
  ...
  static async initRedisClients(Redis: RedisClass, options: RedisOptions, target: PubSubDBEngine | PubSubDBWorker): Promise<void> {
